...
local treesitter = {
  ...
  ["@type.definition"] = { fg = c.teal, italic = true },
  ...
  ["@keyword.type"] = { fg = c.purple, bold = true },
  ["@keyword.conditional"] = { fg = c.blue_bright, bold = true },
  ["@keyword.repeat"] = { fg = c.blue_bright, bold = true },
