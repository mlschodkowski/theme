-- Highlight groups for MLS / GrokDay
...
function M.get(c, variant)
  ...
  if variant == "simple" then
    local secondary = c.magenta
    groups.String = { fg = c.yellow }
    groups.Character = { fg = c.yellow }
    groups.Identifier = { fg = c.fg }
    groups.Function = { fg = c.fg }
    groups.Statement = { fg = secondary }
    groups.Conditional = { fg = secondary }
    groups.Repeat = { fg = secondary }
    groups.Operator = { fg = c.yellow }
    groups.Keyword = { fg = secondary }
    groups.Exception = { fg = secondary }
    groups.PreProc = { fg = secondary }
    groups.Include = { fg = secondary }
    groups.Define = { fg = secondary }
    groups.Macro = { fg = secondary }
    groups.PreCondit = { fg = secondary }
    groups.Type = { fg = secondary }
    groups.StorageClass = { fg = secondary }
    groups.Structure = { fg = secondary }
    groups.Typedef = { fg = secondary }
    groups.Tag = { fg = secondary }
    groups.Delimiter = { fg = c.yellow }

    groups["@string"] = { fg = c.yellow }
    groups["@string.documentation"] = { fg = c.yellow }
    groups["@string.special"] = { fg = c.yellow }
    groups["@variable"] = { fg = c.fg }
    groups["@type"] = { fg = secondary }
    groups["@type.builtin"] = { fg = secondary }
    groups["@type.definition"] = { fg = secondary }
    groups["@type.qualifier"] = { fg = secondary }
    groups["@function"] = { fg = c.fg }
    groups["@function.builtin"] = { fg = c.fg }
    groups["@function.call"] = { fg = c.fg }
    groups["@function.method"] = { fg = c.fg }
    groups["@function.method.call"] = { fg = c.fg }
    groups["@constructor"] = { fg = secondary }
    groups["@operator"] = { fg = c.yellow }
    groups["@keyword"] = { fg = secondary }
    groups["@keyword.function"] = { fg = secondary }
    groups["@keyword.operator"] = { fg = secondary }
    groups["@keyword.import"] = { fg = secondary }
    groups["@keyword.type"] = { fg = secondary }
    groups["@keyword.modifier"] = { fg = secondary }
    groups["@keyword.repeat"] = { fg = secondary }
    groups["@keyword.return"] = { fg = secondary }
    groups["@keyword.exception"] = { fg = secondary }
    groups["@keyword.conditional"] = { fg = secondary }
    groups["@keyword.conditional.ternary"] = { fg = secondary }
    groups["@keyword.coroutine"] = { fg = secondary }
    groups["@punctuation.delimiter"] = { fg = c.yellow }
    groups["@punctuation.bracket"] = { fg = c.yellow }
    groups["@punctuation.special"] = { fg = c.yellow }
    groups["@constant.macro"] = { fg = c.orange }
    groups["@string.regexp"] = { fg = c.yellow }
    groups["@string.escape"] = { fg = c.cyan }
    groups["@string.special.symbol"] = { fg = c.yellow }
    groups["@string.special.path"] = { fg = c.yellow }
    groups["@character"] = { fg = c.yellow }
    groups["@character.special"] = { fg = c.yellow }
    groups["@variable.builtin"] = { fg = c.purple }
    groups["@variable.parameter"] = { fg = c.fg }
    groups["@variable.parameter.builtin"] = { fg = c.fg }
    groups["@variable.member"] = { fg = c.fg }
    groups["@property"] = { fg = c.fg }
    groups["@attribute"] = { fg = secondary }
    groups["@attribute.builtin"] = { fg = secondary }
    groups["@module"] = { fg = secondary }
    groups["@module.builtin"] = { fg = secondary }
    groups["@label"] = { fg = secondary }
    groups["@function.macro"] = { fg = c.fg }
    groups["@keyword.debug"] = { fg = secondary }
    groups["@keyword.directive"] = { fg = secondary }
    groups["@keyword.directive.define"] = { fg = secondary }
    groups["@punctuation.delimiter"] = { fg = c.yellow }
    groups["@punctuation.bracket"] = { fg = c.yellow }
    groups["@punctuation.special"] = { fg = c.yellow }
    groups["@tag"] = { fg = secondary }
    groups["@tag.attribute"] = { fg = secondary }
    groups["@tag.delimiter"] = { fg = c.yellow }
  end
