...
---@param opts MLSConfig|nil
function M.setup(opts)
  M.config = vim.tbl_deep_extend("force", M.config, opts or {})
end

---@param style "night"|"day"|nil
function M.load(style, variant)
  ...
  vim.g.colors_name = variant == "simple" and "mls-simple" or (style == "day" and "mls-day" or "mls")
  vim.o.background = style == "day" and "light" or "dark"

  local palette = require("mls.palette").get(style)
  local groups = require("mls.groups").get(palette, variant)
...
function M.set_terminal_colors(c, style)
  -- Matches ghostty/mls and ghostty/mls-day palette indices
  if style == "day" then
  ...
  vim.g.terminal_color_4 = c.terminal_blue or c.blue
  vim.g.terminal_color_5 = c.magenta
  vim.g.terminal_color_6 = c.cyan
  vim.g.terminal_color_9 = c.red
  vim.g.terminal_color_10 = c.green
  vim.g.terminal_color_11 = c.yellow
  vim.g.terminal_color_12 = c.terminal_blue_bright or c.blue
